...
const PRECACHE = [
  ...
  '/js/worker-analysis.js', '/js/premium.js', '/js/dashboard.js', '/js/auditlog.js', '/js/help.js', '/js/stock.js', '/js/machines.js', '/js/offlineQueue.js', '/js/wip-bags.js',
  '/manifest.json'
];
