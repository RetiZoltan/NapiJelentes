...
import { getFirestore, doc, getDoc, getDocFromServer, setDoc, addDoc,
         ...
         writeBatch, onSnapshot, arrayUnion, Timestamp,
         getCountFromServer }                                 from 'https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js';
...
export {
  ...
  serverTimestamp, writeBatch, onSnapshot, arrayUnion, Timestamp,
  getCountFromServer
};
